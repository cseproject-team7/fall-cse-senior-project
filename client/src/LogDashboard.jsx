...
function LogDashboard() {
    ...
    return (
        <div className="dashboard-container" style={{ padding: '20px' }}>
            ...
            {/* --- Chart 1: Logins Per Application (Unchanged) --- */}
            ...
            <div 
              style={{ 
                // The height is now dynamic based on the (max) 10 items
                height: `${Math.max(patternData.length * 50, 350)}px`, 
                background: '#333',
                borderRadius: '5px',
                padding: '10px'
              }}
